...
namespace Drones
{
    public class StartUp
    {
        ...
        {
            Airfield test = new Airfield("Test", 2, 10.5);

            Console.WriteLine(test.AddDrone(new Drone("", "w", 8)));
            Console.WriteLine(test.AddDrone(new Drone("1", "1", 8)));
            Console.WriteLine(test.AddDrone(new Drone("2", "2", 8)));
            Console.WriteLine(test.AddDrone(new Drone("3", "3", 8)));
            ...
            */
            ...
            airfield.AddDrone(new Drone("Jhon", "Wow", 8));
