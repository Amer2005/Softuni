...
namespace Stealer
{
    public class Spy
    {
        ...
        public string CollectGettersAndSetters(string className)
        {
            ...
            MethodInfo[] setterMethods = classType.GetMethods(
                BindingFlags.Public |
            ...
            MethodInfo[] getterMethods = classType.GetMethods(
                BindingFlags.Public |
                BindingFlags.NonPublic |
                BindingFlags.Instance |
                BindingFlags.Static)
            ...
            foreach (var setMethod in setterMethods)
            {
                result.AppendLine($"{setMethod.Name} will set field of {setMethod.GetParameters().First().ParameterType}");
            }
